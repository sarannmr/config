...
autocmd FileType c,cpp  nnoremap <buffer><silent> <F3>  :call Gcc()<cr>
autocmd FileType c,cpp  nnoremap <buffer><silent> <F4>  :call Run()<cr>
autocmd FileType c,cpp  nnoremap <buffer><silent> <F5>  :call HideOutput()<cr>
